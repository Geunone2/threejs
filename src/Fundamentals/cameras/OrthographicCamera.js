...
export default function OrthographicCamera() {
    ...
    // 1픽셀 = 1 Three.js 유닛 설정
    /*
    camera1.left = -canvas.width / 2;
    camera1.right = canvas.width / 2;
    camera1.top = canvas.height / 2;
    camera1.bottom = -canvas.height / 2;
    camera1.near = -1;
    camera1.far = 1;
    camera1.zoom = 1;
   */
    ...
    */
    ...
    function setScissorForElement(elem) {
        ...
        // Set up the Scissors to only render to that part of the canvas
